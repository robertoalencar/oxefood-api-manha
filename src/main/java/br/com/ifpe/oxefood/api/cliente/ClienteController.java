...
public class ClienteController {
    ...
    @PostMapping
    public ResponseEntity<Cliente> save(@RequestBody @Valid ClienteRequest clienteRequest, 
            HttpServletRequest request) {

        Cliente cliente = clienteService.save(
            clienteRequest.build(), 
    ...
    @Operation(
        summary = "Serviço responsável por retornar o cliente referente ao ID passado na URI.",
        description = "Exemplo de descrição de um endpoint responsável por inserir um cliente no sistema."
    )
    @GetMapping("/{id}")
    ...
    @Operation(
        summary = "Serviço responsável por cadastrar um endereço de um cliente no sistema."
    )
